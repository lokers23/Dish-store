...
namespace DishStore.DAL
{
    public partial class DishStoreDbContext : DbContext
    {
        public DishStoreDbContext()
        {
        }

        public DishStoreDbContext(DbContextOptions<DishStoreDbContext> options)
            : base(options)
        {
        }
